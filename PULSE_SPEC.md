# ayoo — Техническая спецификация для Claude Code
...
| # | Решение | Значение |
|---|---|---|
| 1 | Юр. структура | Новый entity (отдельное юр. лицо под ayoo) |
...
**ayoo** — программа лояльности нового типа, где:
...
| Аспект | Классические (Plazius, Spasibo) | ayoo |
|---|---|---|
...
- **ayoo Mobile** (iOS + Android) — для юзеров
- **ayoo Merchant** (Web) — кабинет заведения, Next.js на том же backend
...
Юзер может отправить любому другому юзеру ayoo свои баллы. Лимиты:
...
```
Я делаю ayoo — программу лояльности с конкурентным курсом баллов между заведениями.
...
Сейчас работаем над Tier 1 (см. ayoo spec, раздел 12).
...
Спека в ayoo spec. Если есть вопросы по архитектуре — задавай ДО старта.
