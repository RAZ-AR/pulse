  ...
  return (
    <Tabs
      screenOptions={{
        ...
        tabBarStyle: {
          backgroundColor: isRainbow ? "rgba(242,242,246,0.96)" : "rgba(255,255,255,0.92)",
          borderTopWidth: 0,
          height: 64,
          marginHorizontal: 12,
          marginBottom: bottomReserve,
          borderRadius: 32,
          shadowColor: isRainbow ? "#AA00FF" : "#A3B1C6",
          shadowOffset: { width: 0, height: 12 },
          shadowOpacity: isRainbow ? 0.28 : 0.22,
          shadowRadius: 20,
          elevation: 8,
          ...(isRainbow ? { borderWidth: 1, borderColor: "rgba(180,160,255,0.30)" } : {}),
        },
