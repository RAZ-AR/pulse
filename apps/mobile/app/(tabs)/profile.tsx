...
const s = StyleSheet.create({
  ...
  statLabel: { color: "#75736A", fontSize: 9, marginTop: 4, letterSpacing: 0.8, fontWeight: "700" },
  ...
  accountLabel: { color: "#75736A", fontSize: 9, letterSpacing: 0.8 },
  ...
  badgeRarity: { color: "#75736A", fontSize: 9, marginTop: 2, letterSpacing: 0.5, fontWeight: "700" },

  referralCard: { padding: 17, marginBottom: 16, alignItems: "center", borderRadius: 32 },
  referralLabel: { color: "#75736A", fontSize: 11, letterSpacing: 1.5, fontWeight: "700", marginBottom: 8 },
  referralCode: { color: colors.ink, fontSize: 25, letterSpacing: 4 },
  referralHint: { color: "#75736A", fontSize: 11, marginTop: 8, textAlign: "center" },
  qrWrap: { alignItems: "center", marginTop: 16, padding: 12, backgroundColor: "rgba(255,255,255,0.95)", borderRadius: 20 },
  qrHint: { color: "#75736A", fontSize: 11, marginTop: 8, textAlign: "center" },
