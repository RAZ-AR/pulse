      ...
      <ScrollView style={[s.scroll, { backgroundColor: theme.bg }]} contentContainerStyle={s.content}>
        ...
        {!isJoined ? (
          ...
          <NeuCard gradient={isRainbow ? undefined : gradients.black} style={{ padding: 18, alignItems: "center", borderRadius: 30, backgroundColor: isRainbow ? "#F2F2F6" : undefined }}>
            ...
            <Text style={[s.completedSub, { color: isRainbow ? neonColors.cyan : "#75736A" }]}>+{c.pointsReward} pts {t("addedToBalance", "added to your balance")}</Text>
          </NeuCard>
        ) : (
          <Pressable
            onPress={() => router.back()}
...
const s = StyleSheet.create({
  ...
  heroIcon: { color: "#75736A", fontSize: 48, lineHeight: 52, fontWeight: "900", marginBottom: 8 },
  ...
  completedSub: { color: "#75736A", fontSize: 12, marginTop: 4 },
