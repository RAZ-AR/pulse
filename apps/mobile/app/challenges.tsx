...
const ss = StyleSheet.create({
  ...
  iconText: { color: "#75736A", fontSize: 20, fontWeight: "900" },
  title: { color: colors.ink, fontSize: 16 },
  desc: { color: "#75736A", fontSize: 12, marginTop: 2 },
  reward: { color: colors.ink, fontSize: 20, lineHeight: 22 },
  rewardUnit: { color: "#75736A", fontSize: 10 },
  ...
  progressText: { color: "#75736A", fontSize: 11 },
