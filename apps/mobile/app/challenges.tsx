...
function Empty({
  ...
  return (
    <NeuCard style={{ padding: 28, alignItems: "center" }}>
      ...
      {action ? (
        <Pressable onPress={onAction} style={[s.emptyBtn, { backgroundColor: "#FFFFFF" }, theme.shadowRaisedSm]}>
...
const ss = StyleSheet.create({
  ...
  iconText: { color: "#000000", fontSize: 20, fontWeight: "900" },
  title: { color: colors.ink, fontSize: 16 },
  desc: { color: "#000000", fontSize: 12, marginTop: 2 },
  reward: { color: colors.ink, fontSize: 20, lineHeight: 22 },
  rewardUnit: { color: "#000000", fontSize: 10 },
  ...
  progressText: { color: "#000000", fontSize: 11 },
