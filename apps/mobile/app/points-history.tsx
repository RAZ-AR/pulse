        ...
        {([
          ...
          return (
            <Pressable key={key} onPress={() => setFilter(key)} style={[s.filterChip, active ? s.filterChipActive : s.filterChipIdle]}>
              <Text style={[s.filterText, { color: active ? (isRainbow ? theme.text : colors.ink) : "#75736A", fontFamily: fonts.bodyBold }]}>{label}</Text>
            </Pressable>
          )
        })}
      </View>
...
const s = StyleSheet.create({
  ...
  backButton: { width: 46, height: 46, borderRadius: 23, alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF", shadowColor: "#C9C4B4", shadowOffset: { width: 4, height: 4 }, shadowOpacity: 0.28, shadowRadius: 8, elevation: 2 },
  backText: { color: "#75736A", fontSize: 32, lineHeight: 34, fontWeight: "800" },
  kicker: { color: "#A5A299", fontSize: 11, letterSpacing: 1.8 },
  title: { color: "#33322D", fontSize: 34, lineHeight: 38, letterSpacing: 0 },
  ...
  metricValue: { color: "#33322D", fontSize: 25, lineHeight: 29, letterSpacing: 0 },
  metricMuted: { color: "#75736A" },
  metricLabel: { color: "#75736A", fontSize: 9, marginTop: 6, textTransform: "uppercase" },
  ...
  emptyText: { color: "#75736A", fontSize: 13, fontWeight: "700" },
  ...
  txIcon: { width: 44, height: 44, borderRadius: 18, alignItems: "center", justifyContent: "center", shadowColor: "#C9C4B4", shadowOffset: { width: 4, height: 4 }, shadowOpacity: 0.2, shadowRadius: 7, elevation: 2 },
  ...
  txIconText: { color: "#75736A", fontSize: 17 },
  txMain: { flex: 1, minWidth: 0 },
  txTitle: { color: "#33322D", fontSize: 15 },
  txMeta: { color: "#75736A", fontSize: 11, marginTop: 2 },
  txPoints: { fontSize: 19, minWidth: 64, textAlign: "right" },
  txPointsEarn: { color: "#57B286" },
