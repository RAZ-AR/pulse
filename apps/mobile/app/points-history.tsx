        ...
        {([
          ...
          return (
            <Pressable key={key} onPress={() => setFilter(key)} style={[s.filterChip, active ? s.filterChipActive : s.filterChipIdle]}>
              <Text style={[s.filterText, { color: active ? (isRainbow ? theme.text : colors.ink) : "#000000", fontFamily: fonts.bodyBold }]}>{label}</Text>
            </Pressable>
          )
        })}
      </View>
...
const s = StyleSheet.create({
  ...
  backButton: { width: 46, height: 46, borderRadius: 23, alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF", shadowColor: "#000000", shadowOffset: { width: 4, height: 4 }, shadowOpacity: 0.28, shadowRadius: 8, elevation: 2 },
  backText: { color: "#000000", fontSize: 32, lineHeight: 34, fontWeight: "800" },
  kicker: { color: "#000000", fontSize: 11, letterSpacing: 1.8 },
  title: { color: "#000000", fontSize: 34, lineHeight: 38, letterSpacing: 0 },
  summary: { minHeight: 132, borderRadius: 34, padding: 13, marginBottom: 14, flexDirection: "row", gap: 8, overflow: "hidden" },
  summaryGlow: { position: "absolute", right: -70, top: -80, width: 190, height: 190, borderRadius: 95, backgroundColor: "#FFFFFF" },
  ...
  metricValue: { color: "#000000", fontSize: 25, lineHeight: 29, letterSpacing: 0 },
  metricMuted: { color: "#000000" },
  metricLabel: { color: "#000000", fontSize: 9, marginTop: 6, textTransform: "uppercase" },
  ...
  emptyText: { color: "#000000", fontSize: 13, fontWeight: "700" },
  ...
  txIcon: { width: 44, height: 44, borderRadius: 18, alignItems: "center", justifyContent: "center", shadowColor: "#000000", shadowOffset: { width: 4, height: 4 }, shadowOpacity: 0.2, shadowRadius: 7, elevation: 2 },
  txIconEarn: { backgroundColor: "#FFFFFF" },
  txIconSpend: { backgroundColor: "#FFFFFF" },
  ...
  txTitle: { color: "#000000", fontSize: 15 },
  txMeta: { color: "#000000", fontSize: 11, marginTop: 2 },
  txPoints: { fontSize: 19, minWidth: 64, textAlign: "right" },
  txPointsEarn: { color: "#67C887" },
  txPointsSpend: { color: "#ea5b0c" },
})
