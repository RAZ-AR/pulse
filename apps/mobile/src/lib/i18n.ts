  ...
  await i18n.use(initReactI18next).init({
    resources: {
      en: {
        ...
        rewards: enRewards, checkin: enCheckin, venue: enVenue, transactions: enTransactions,
      },
      ru: {
        common: ruCommon, auth: ruAuth, profile: ruProfile,
        rewards: ruRewards, checkin: ruCheckin, venue: ruVenue, transactions: ruTransactions,
      },
      sr: {
        common: srCommon, auth: srAuth, profile: srProfile,
        rewards: srRewards, checkin: srCheckin, venue: srVenue, transactions: srTransactions,
      },
    },
    lng: locale,
    fallbackLng: "en",
    defaultNS: "common",
    ns: ["common", "auth", "profile", "rewards", "checkin", "venue", "transactions"],
