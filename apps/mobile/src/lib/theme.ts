...
export const gradients = {
  ...
  lava: ["#FF7DB8", "#7BE7F2", "#C9F65D", "#FF9A7A"] as const,
  lavaGlass: ["rgba(255,125,184,0.74)", "rgba(123,231,242,0.62)", "rgba(201,246,93,0.58)", "rgba(255,154,122,0.68)"] as const,
  black: ["#FF7DB8", "#7BE7F2", "#C9F65D", "#FF9A7A"] as const,
  graphite: ["#FF7DB8", "#7BE7F2", "#C9F65D", "#FF9A7A"] as const,
  pearl: ["#FFFFFF", "#EEF3FA"] as const,
  lime: ["#D9F875", "#BFF04C"] as const,
  blush: ["#F7D6EA", "#DDE6FF"] as const,
  rainbow: ["#A7E8EE", "#EAF1FF"] as const,
  rainbow2: ["#FF7DB8", "#7BE7F2", "#C9F65D", "#FF9A7A"] as const,
