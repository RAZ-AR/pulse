...
export const gradients = {
  ...
  lava: ["#F3EFEA", "#FF9A22", "#FF5B5F", "#7ADDF3", "#E6F2DF", "#252A31"] as const,
  lavaGlass: [
    "rgba(243,239,234,0.82)",
    "rgba(255,154,34,0.56)",
    "rgba(255,91,95,0.52)",
    "rgba(122,221,243,0.46)",
    "rgba(230,242,223,0.64)",
  ] as const,
  black: ["#24282F", "#101217", "#05060A"] as const,
  graphite: ["#343941", "#15181E", "#07080C"] as const,
  pearl: ["#FFFFFF", "#EEF3FA"] as const,
  lime: ["#D9F875", "#BFF04C"] as const,
  blush: ["#F7D6EA", "#DDE6FF"] as const,
  rainbow: ["#A7E8EE", "#EAF1FF"] as const,
  rainbow2: ["#FF9A22", "#FF5B5F", "#7ADDF3", "#E6F2DF"] as const,
